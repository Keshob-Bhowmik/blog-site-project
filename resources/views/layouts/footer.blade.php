    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition duration-200">About</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition duration-200">Services</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition duration-200">Documentation</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-6 mt-4 md:mt-0">
                <a href="#" class="text-gray-300 hover:text-white text-sm transition duration-200">Privacy</a>
                <a href="#" class="text-gray-300 hover:text-white text-sm transition duration-200">Terms</a>
                <a href="#" class="text-gray-300 hover:text-white text-sm transition duration-200">Cookies</a>
            </div>
        </div>
    </div>
</footer>
