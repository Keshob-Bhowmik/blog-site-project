...
// Add autocomplete route (public access)
Route::get('/api/users/autocomplete', [PostController::class, 'autocomplete'])->name('users.autocomplete');
Route::get('/api/categories/autocomplete', [CategoryController::class, 'autocomplete'])->name('categories.autocomplete');
